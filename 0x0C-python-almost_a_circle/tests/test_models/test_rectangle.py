...
class TestRectangle(unittest.TestCase):
    ...
    def test_0_id(self):
        ...
        Rect1 = Rectangle(10, 11)
        Rect2 = Rectangle(11, 12, 13)
        Rect3 = Rectangle(12, 13, 14, 15)
    ...
    def test_4_area(self):
        ...
        Rect3 = Rectangle(3, 4, 5, 6)
        Rect4 = Rectangle(4, 5, 6, 7, 8)
        Rect5 = Rectangle(9999999999999, 99999999999999)
        self.assertEqual(Rect1.area(), 2)
        self.assertEqual(Rect2.area(), 2 * 3)
        self.assertEqual(Rect3.area(), 3 * 4)
        self.assertEqual(Rect4.area(), 4 * 5)
        self.assertEqual(Rect5.area(), 9999999999999 * 99999999999999)
